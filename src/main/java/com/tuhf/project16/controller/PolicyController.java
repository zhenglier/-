...
public class PolicyController {
    ...
    */
    ...
    public Collection<PolicyTableVO> getBriefsByTags(@RequestParam Map<String, String> params) {
        Collection<PolicyTableVO> policies = policyService.getBriefsByTags(params.values());
        return policies;
    }

    /* 按页获取概要 */
    @RequestMapping(value = "/brief", method = RequestMethod.GET, params = {"page"})
    public Collection<PolicyTableVO> getBriefsByPage(@RequestParam Map<String, String> params) {
        Collection<PolicyTableVO> policies = policyService.getBriefsByPage(Integer.parseInt(params.get("page")));
        return policies;
    }

    @GetMapping("/brief")
    public Collection<PolicyTableVO> getAllBriefs() {
        Collection<PolicyTableVO> policies = policyService.getAllBriefs();
        return policies;
    }
